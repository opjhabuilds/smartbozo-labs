...
- Cards stamped `sunset` are retired, not active, and are excluded from the product count. Count only the non-`sunset` specimen cards when updating those three places.
